...
//import org.testng.annotations.FastJsonUtil;
//
//import ztest.ZTestReport;
//
//@Listeners({ztest.ZTestReport.class})
...
//	}
//
//	@FastJsonUtil(description="测试DEMO")
...
//	}
//
//	@FastJsonUtil(description="测试DEMO1")
//	public void testDemo1(){
//		Reporter.log("this is demo!");
//		Assert.assertEquals("a", "b", "should be equals.");
//	}
//
//	@FastJsonUtil(description="测试DEMO2",dataProvider="test")
//	public void testDemo2(int a){
//		Reporter.log("this is demo!");
//		Assert.assertEquals(a, 1, "should be equals.");
//	}
//
//	@FastJsonUtil(description="测试DEMO3")
